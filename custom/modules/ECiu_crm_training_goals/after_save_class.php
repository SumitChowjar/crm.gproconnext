...
class after_save_class
{
    function insert_email($bean, $event, $arguments)
    {
        ...
        }elseif( isset($bean->eciu_crm_training_goals_contactscontacts_ida->focus->eciu_crm_training_goals_contacts->beans) && !empty($bean->eciu_crm_training_goals_contactscontacts_ida->focus->eciu_crm_training_goals_contacts->beans) ){
        ...
        {
            $query = "SELECT email_addressesß.email_address as email FROM email_addresses
        ...
        //update goals total for leads
        $goals_total = $bean->y2016 + $bean->y2017 + $bean->y2018 + $bean->y2019 + $bean->y2020;
        $bean->total = $goals_total;
        $bean->save();
