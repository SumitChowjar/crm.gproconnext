       ...
       $query ="SELECT COUNT(DISTINCT ct.id) as contacts, ct.primary_address_country, SUM(actuals.number_of_pastors) as no_of_trained_pastors, count(actuals.id) as no_of_trainings FROM eciu_crm_training_actuals_contacts_c AS tac
        ...
        ORDER BY ct.primary_address_country ASC";
         ...
         $result = $db->query($query);
            ...
            $str .= '<div class="moduleTitle"><h2> Country Report </h2><div class="clear"></div></div>';
           ...
           $str.='</th>';
	         $str.='<th scope="col">';
           $str.='<div style="white-space: normal;" width="100%" align="letf">';
           $str.='<span style="cursor:pointer" onclick=sort_Countries_Training_Report("no_of_trainings")>No. of Trainings</span>';
           $str.='<img src="custom/js/if_sort.png" style="height:12px;">';
           ...
           $str.='</thead>';
              ...
              while( $row = $db->fetchByAssoc($result) )
            {
              ...
              $str.='</td>';
              $str.='<td class valign="top" align="left">';
              $str.= '<span class="sugar_field" id="last_name"> '.$row['no_of_trainings'].' </span>';
              $str.='</td>';
              $str.='<td class valign="top" align="left">';
              ...
              $total_contacts += $row['contacts'];
	            $total_training += $row['no_of_trainings'];
              ...
              $str.='</th>';
	            $str.='<th class valign="top" align="left">';
              $str.= '<span class="sugar_field"> Total Trainings: '.$total_training.' </span>';
              $str.='</th>';
	            $str.='<th class valign="top" align="left">';
