<?php /* Smarty version 2.6.29, created on 2018-08-02 20:26:26
         compiled from include/SugarFields/Fields/CustomAddress/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'include/SugarFields/Fields/CustomAddress/EditView.tpl', 42, false),array('modifier', 'cat', 'include/SugarFields/Fields/CustomAddress/EditView.tpl', 43, false),array('modifier', 'lower', 'include/SugarFields/Fields/CustomAddress/EditView.tpl', 54, false),array('modifier', 'in_array', 'include/SugarFields/Fields/CustomAddress/EditView.tpl', 54, false),array('modifier', 'default', 'include/SugarFields/Fields/CustomAddress/EditView.tpl', 60, false),)), $this); ?>
{*
/*********************************************************************************
...
' <?php endif; ?>  >{$fields.<?php echo $this->_tpl_vars['street']; ?>
.value}</textarea>
<?php else: ?>
<textarea id="<?php echo $this->_tpl_vars['street']; ?>
" name="<?php echo $this->_tpl_vars['street']; ?>
...
<td>
<select name="<?php echo $this->_tpl_vars['country']; ?>
" width="<?php echo ((is_array($_tmp=@$this->_tpl_vars['displayParams']['size'])) ? $this->_run_mod_handler('default', true, $_tmp, 30) : smarty_modifier_default($_tmp, 30)); ?>
" id="<?php echo $this->_tpl_vars['country']; ?>
" title="<?php echo $this->_tpl_vars['vardef']['help']; ?>
" tabindex="<?php echo $this->_tpl_vars['tabindex']; ?>
" <?php if (isset ( $this->_tpl_vars['displayParams']['script'] )): ?><?php echo $this->_tpl_vars['displayParams']['script']; ?>
<?php endif; ?>>
{if isset($fields.<?php echo $this->_tpl_vars['country']; ?>
.value) && $fields.<?php echo $this->_tpl_vars['country']; ?>
.value != ''}
     {html_options options=$fields.<?php echo $this->_tpl_vars['country']; ?>
.options selected=$fields.<?php echo $this->_tpl_vars['country']; ?>
.value}
{else}
     {html_options options=$fields.<?php echo $this->_tpl_vars['country']; ?>
.options selected=$fields.<?php echo $this->_tpl_vars['country']; ?>
