<?php /* Smarty version 2.6.29, created on 2018-08-06 16:09:28
         compiled from cache/themes/Suite7/modules/ECiu_crm_training_goals/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/Suite7/modules/ECiu_crm_training_goals/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/Suite7/modules/ECiu_crm_training_goals/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/Suite7/modules/ECiu_crm_training_goals/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/ECiu_crm_training_goals/SearchForm_popup_query_form.tpl', 45, false),array('function', 'sugar_getimage', 'cache/themes/Suite7/modules/ECiu_crm_training_goals/SearchForm_popup_query_form.tpl', 70, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ECiu_crm_training_goals'), $this);?>
</label>
    	</td>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_accounts_eciu_crm_training_goals_1_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_accounts_eciu_crm_training_goals_1_name_advanced","accounts_eciu_crm_training_goals_1accounts_ida_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["accounts_eciu_crm_training_goals_1accounts_ida"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_leads_eciu_crm_training_goals_1_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Leads"],"group":"or","field_list":["name","id"],"populate_list":["leads_eciu_crm_training_goals_1_name_advanced","leads_eciu_crm_training_goals_1leads_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_eciu_crm_training_goals_contacts_name_advanced\']={"form":"popup_query_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["eciu_crm_training_goals_contacts_name_advanced","eciu_crm_training_goals_contactscontacts_ida_advanced","eciu_crm_training_goals_contactscontacts_ida_advanced","eciu_crm_training_goals_contactscontacts_ida_advanced"],"required_list":["eciu_crm_training_goals_contactscontacts_ida"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"No Match"};</script>'; ?>