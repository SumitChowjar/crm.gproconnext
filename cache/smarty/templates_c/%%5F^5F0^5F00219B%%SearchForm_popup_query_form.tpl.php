<?php /* Smarty version 2.6.29, created on 2018-08-01 06:05:07
         compiled from cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_popup_query_form.tpl', 45, false),array('function', 'sugar_getimage', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_popup_query_form.tpl', 142, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='category_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATEGORY','module' => 'ECiu_crm_resource_types'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['category_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['category_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['category_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['category_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['category_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='sub_category_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUB_CATEGORY','module' => 'ECiu_crm_resource_types'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['sub_category_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['sub_category_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['sub_category_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['sub_category_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['sub_category_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ECiu_crm_resource_types'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
