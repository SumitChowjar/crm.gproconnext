<?php /* Smarty version 2.6.29, created on 2018-08-01 06:05:22
         compiled from include/SugarFields/Fields/Radioenum/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Radioenum/EditView.tpl', 41, false),)), $this); ?>
{*
/*********************************************************************************
...
{/if}
{capture name=idname assign=idname}<?php echo smarty_function_sugarvar(array('key' => 'name'), $this);?>
{/capture}
<?php if (! empty ( $this->_tpl_vars['displayParams']['idName'] )): ?>
    {assign var=idname value='<?php echo $this->_tpl_vars['displayParams']['idName']; ?>
'}
<?php endif; ?>
...
{if isset(<?php echo smarty_function_sugarvar(array('key' => 'value','string' => true), $this);?>
 ...
 != ''}
	{html_radios id="$idname" <?php if (! empty ( $this->_tpl_vars['displayParams']['accesskey'] )): ?> accesskey='<?php echo $this->_tpl_vars['displayParams']['accesskey']; ?>
' <?php endif; ?>   name="$idname" title="<?php echo $this->_tpl_vars['vardef']['help']; ?>
