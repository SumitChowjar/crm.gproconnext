<?php /* Smarty version 2.6.29, created on 2018-08-14 03:00:50
         compiled from cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_basic.tpl', 44, false),array('function', 'sugar_getimagepath', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_basic.tpl', 130, false),array('modifier', 'count', 'cache/themes/Suite7/modules/ECiu_crm_resource_types/SearchForm_basic.tpl', 117, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='category_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATEGORY','module' => 'ECiu_crm_resource_types'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['category_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['category_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['category_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['category_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['category_basic']['name']; ?>
' size='30' 
    maxlength='255' 
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='sub_category_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUB_CATEGORY','module' => 'ECiu_crm_resource_types'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['sub_category_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['sub_category_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['sub_category_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['sub_category_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['sub_category_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ECiu_crm_resource_types'), $this);?>
