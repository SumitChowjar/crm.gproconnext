...
<div style="float:left; text-align: right; width: 30%; font-size: 12px;">
	<?php if ($this->_tpl_vars['view'] == 'sharedWeek' || $this->_tpl_vars['view'] == 'sharedMonth'): ?>
		<input id="userListButtonId" type="button" class="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_EDIT_USERLIST']; ?>
...
,
	...
	<?php endif; ?>
	<input type="button" id="cal_settings" class="btn btn-info" onclick="CAL.toggle_settings()" value="<?php echo $this->_tpl_vars['MOD']['LBL_SETTINGS']; ?>
">
</div>
