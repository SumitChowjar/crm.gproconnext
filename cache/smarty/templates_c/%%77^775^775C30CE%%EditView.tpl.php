<?php /* Smarty version 2.6.29, created on 2018-08-14 03:08:39
         compiled from cache/themes/Suite7/modules/ECiu_crm_ddc/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/Suite7/modules/ECiu_crm_ddc/EditView.tpl', 38, false),array('modifier', 'strip_semicolon', 'cache/themes/Suite7/modules/ECiu_crm_ddc/EditView.tpl', 57, false),array('function', 'sugar_include', 'cache/themes/Suite7/modules/ECiu_crm_ddc/EditView.tpl', 44, false),array('function', 'counter', 'cache/themes/Suite7/modules/ECiu_crm_ddc/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/ECiu_crm_ddc/EditView.tpl', 56, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=ECiu_crm_ddc'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_KEY_ID','module' => 'ECiu_crm_ddc'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['key_id']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['key_id']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['key_id']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['key_id']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['key_id']['name']; ?>
' size='30' 
maxlength='20' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='name_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ECiu_crm_ddc'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
