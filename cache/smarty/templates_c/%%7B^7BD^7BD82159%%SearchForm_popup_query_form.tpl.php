<?php /* Smarty version 2.6.29, created on 2018-08-13 10:57:22
         compiled from cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl', 44, false),array('function', 'html_options', 'cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl', 84, false),array('function', 'sugar_getimage', 'cache/themes/Suite7/modules/Accounts/SearchForm_popup_query_form.tpl', 293, false),)), $this); ?>
...
<?php echo smarty_function_html_options(array('id' => 'account_type_advanced','name' => 'account_type_advanced[]','options' => $this->_tpl_vars['fields']['account_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['account_type_advanced']['value']), $this);?>
...
<?php echo smarty_function_html_options(array('id' => 'industry_advanced','name' => 'industry_advanced[]','options' => $this->_tpl_vars['fields']['industry_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['industry_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='billing_address_state_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_STATE','module' => 'Accounts'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['billing_address_state_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['billing_address_state_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['billing_address_state_advanced']['value']); ?>
<?php endif; ?>  
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='billing_address_country_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_COUNTRY','module' => 'Accounts'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
