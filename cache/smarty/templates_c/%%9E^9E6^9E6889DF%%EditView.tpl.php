<?php /* Smarty version 2.6.29, created on 2018-08-03 14:00:39
         compiled from cache/themes/Suite7/modules/Calls/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 43, false),array('modifier', 'default', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 54, false),array('modifier', 'strip_semicolon', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 72, false),array('modifier', 'lookup', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 130, false),array('modifier', 'count', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 232, false),array('function', 'sugar_include', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 49, false),array('function', 'counter', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 55, false),array('function', 'sugar_getimagepath', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 58, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 61, false),array('function', 'html_options', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 105, false),array('function', 'sugar_getimage', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 622, false),array('function', 'sugar_getjspath', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 630, false),array('function', 'sugar_getscript', 'cache/themes/Suite7/modules/Calls/EditView.tpl', 1109, false),)), $this); ?>
...
" class="button primary" onclick="SUGAR.calls.fill_invitees();document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value=''; <?php endif; ?>formSubmitCheck();;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=Calls'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
" id="SAVE_SEND_HEADER" class="button" onclick="document.EditView.send_invites.value='1';SUGAR.calls.fill_invitees();document.EditView.action.value='Save';document.EditView.return_action.value='EditView';document.EditView.return_module.value='<?php echo $_REQUEST['return_module']; ?>
...
" id="CLOSE_CREATE_HEADER" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE_AND_CREATE_BUTTON_KEY']; ?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='LBL_CALL_INFORMATION'  class="yui3-skin-sam edit view panelContainer">
...
<input accesskey=""  tabindex="0"  id="duration_hours" name="duration_hours" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
...
function formSubmitCheck(){var duration=true;if(typeof(isValidDuration)!="undefined"){duration=isValidDuration();}if(check_form('EditView') && duration){SUGAR.ajaxUI.submitForm("EditView");}}</script>
...
" id="SAVE_SEND_FOOTER" class="button" onclick="document.EditView.send_invites.value='1';SUGAR.calls.fill_invitees();document.EditView.action.value='Save';document.EditView.return_action.value='EditView';document.EditView.return_module.value='<?php echo $_REQUEST['return_module']; ?>
';formSubmitCheck();;" type="button" name="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_SEND_BUTTON_LABEL']; ?>
"/>
<?php if ($this->_tpl_vars['fields']['status']['value'] != 'Held'): ?><input title="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE_AND_CREATE_BUTTON_TITLE']; ?>
" id="CLOSE_CREATE_FOOTER" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE_AND_CREATE_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.calls.fill_invitees(); document.EditView.status.value='Held'; document.EditView.action.value='Save'; document.EditView.return_module.value='Calls'; document.EditView.isDuplicate.value=true; document.EditView.isSaveAndNew.value=true; document.EditView.return_action.value='EditView'; document.EditView.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
'; formSubmitCheck();" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE_AND_CREATE_BUTTON_LABEL']; ?>
"/><?php endif; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'reschedule_history\', \'varchar\', false,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'call_medium_c\', \'enum\', false,\''; ?>
