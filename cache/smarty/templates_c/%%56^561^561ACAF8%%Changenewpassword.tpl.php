<?php /* Smarty version 2.6.29, created on 2018-08-02 19:10:33
...
<!--
var ERR_RULES_NOT_MET = \''; ?>
<?php echo $this->_tpl_vars['MOD']['ERR_RULES_NOT_MET']; ?>
<?php echo '\';
var ERR_ENTER_OLD_PASSWORD = \''; ?>
<?php echo $this->_tpl_vars['MOD']['ERR_ENTER_OLD_PASSWORD']; ?>
<?php echo '\';
var ERR_ENTER_NEW_PASSWORD = \''; ?>
<?php echo $this->_tpl_vars['MOD']['ERR_ENTER_NEW_PASSWORD']; ?>
<?php echo '\';
var ERR_ENTER_CONFIRMATION_PASSWORD = \''; ?>
<?php echo $this->_tpl_vars['MOD']['ERR_ENTER_CONFIRMATION_PASSWORD']; ?>
<?php echo '\';
var ERR_REENTER_PASSWORDS = \''; ?>
<?php echo $this->_tpl_vars['MOD']['ERR_REENTER_PASSWORDS']; ?>
<?php echo '\';
-->
</script>
<script type=\'text/javascript\' src=\''; ?>
<?php echo smarty_function_sugar_getjspath(array('file' => "modules/Users/PasswordRequirementBox.js"), $this);?>
<?php echo '\'></script>
<style type="text/css">
<!--
.body 
...
:</td>
			<td width="30%"><input type="password" size="26" tabindex="2" id="confirm_pwd" name="confirm_pwd" value="" onkeyup="password_confirmation();" /> <div id="comfirm_pwd_match" class="error" style="display: none;"><?php echo $this->_tpl_vars['MOD']['LBL_PASSWORD_MIS_MATCH']; ?>
</div></td>
		</tr>
		<tr>
