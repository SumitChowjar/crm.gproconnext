...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='denomination_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DENOMINATION_ID','module' => 'ECiu_crm_denominations'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['denomination_id_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['denomination_id_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['denomination_id_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['denomination_id_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['denomination_id_advanced']['name']; ?>
' size='30' 
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ECiu_crm_denominations'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
