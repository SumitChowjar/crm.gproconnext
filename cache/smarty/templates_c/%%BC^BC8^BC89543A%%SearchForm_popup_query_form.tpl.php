<?php /* Smarty version 2.6.29, created on 2018-08-06 16:09:41
         compiled from cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 45, false),array('function', 'html_options', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 49, false),array('function', 'sugar_getimage', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 152, false),array('modifier', 'default', 'cache/themes/Suite7/modules/ECiu_crm_training_actuals/SearchForm_popup_query_form.tpl', 163, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='recourd_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RECOURD_TYPE','module' => 'ECiu_crm_training_actuals'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'recourd_type_advanced','name' => 'recourd_type_advanced[]','options' => $this->_tpl_vars['fields']['recourd_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['recourd_type_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ECiu_crm_training_actuals'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='number_of_pastors_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NUMBER_OF_PASTORS','module' => 'ECiu_crm_training_actuals'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['number_of_pastors_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['number_of_pastors_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['number_of_pastors_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['number_of_pastors_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['number_of_pastors_advanced']['name']; ?>
' size='30' 
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='date_from_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_FROM','module' => 'ECiu_crm_training_actuals'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['date_from_advanced']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['date_from_advanced']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['date_from_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex=''    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['date_from_advanced']['name']; ?>
...
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['date_from_advanced']['name']; ?>
",
...
",
button : "<?php echo $this->_tpl_vars['fields']['date_from_advanced']['name']; ?>
_trigger",
singleClick : true,
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='date_to_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_TO','module' => 'ECiu_crm_training_actuals'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['date_to_advanced']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['date_to_advanced']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['date_to_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex=''    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['date_to_advanced']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
<?php echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
...
<script type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['date_to_advanced']['name']; ?>
",
form : "popup_query_form",
ifFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
daFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
button : "<?php echo $this->_tpl_vars['fields']['date_to_advanced']['name']; ?>
_trigger",
singleClick : true,
dateStr : "<?php echo $this->_tpl_vars['date_value']; ?>
",
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='hours_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HOURS','module' => 'ECiu_crm_training_actuals'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['hours_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['hours_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['hours_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['hours_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['hours_advanced']['name']; ?>
' size='30' 
