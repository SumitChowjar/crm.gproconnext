<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    'preferred_day_time_of_contac_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Preferred Day Time of Contact',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'preferred_day_time_of_contac_c',
      'vname' => 'LBL_PREFERRED_DAY_TIME_OF_CONTAC',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'preferred_day_time_of_contact_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactspreferred_day_time_of_contac_c',
      'custom_module' => 'Contacts',
    ),
    'stake_holder_type_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Stakeholder Type',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'stake_holder_type_c',
      'vname' => 'LBL_STAKE_HOLDER_TYPE',
      'type' => 'multienum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'stakeholder_type_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Contactsstake_holder_type_c',
      'custom_module' => 'Contacts',
    ),
    ...
    'preferred_frequen_of_contact_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Preferred Frequency of Contact',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'preferred_frequen_of_contact_c',
      'vname' => 'LBL_PREFERRED_FREQUEN_OF_CONTACT',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'preferred_frequency_of_contact_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactspreferred_frequen_of_contact_c',
      'custom_module' => 'Contacts',
    ),
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Wedding Anniversary',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wedding_anniversary_c',
      'vname' => 'LBL_WEDDING_ANNIVERSARY',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => 'Contactswedding_anniversary_c',
      'custom_module' => 'Contacts',
    ),
    ...
    'preferred_method_of_descrip_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Preferred Method of Contact Description',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'preferred_method_of_descrip_c',
      'vname' => 'LBL_PREFERRED_METHOD_OF_DESCRIP',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactspreferred_method_of_descrip_c',
      'custom_module' => 'Contacts',
    ),
    'opsunit_c' => 
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'opsunit_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactsopsunit_c',
      'custom_module' => 'Contacts',
    ),
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Google Hangouts',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'google_hangouts_c',
      'vname' => 'LBL_GOOGLE_HANGOUTS',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'size' => '20',
      'dbType' => 'varchar',
      'id' => 'Contactswhatsapp_c',
      'custom_module' => 'Contacts',
    ),
    'pastoral_journey_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Pastoral Journey',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'pastoral_journey_c',
      'vname' => 'LBL_PASTORAL_JOURNEY',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'pastoral_journey_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactspastoral_journey_c',
      'custom_module' => 'Contacts',
    ),
    'preferred_method_of_contact_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Preferred Method of Contact',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'preferred_method_of_contact_c',
      'vname' => 'LBL_PREFERRED_METHOD_OF_CONTACT',
      'type' => 'multienum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'preferred_method_of_contact_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Contactspreferred_method_of_contact_c',
      'custom_module' => 'Contacts',
    ),
