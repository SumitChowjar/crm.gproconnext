...
<li><a id="tab2" href="javascript:void(0)"><em>{sugar_translate label='LBL_PANEL_ASSIGNMENT' module='Accounts'}</em></a></li>
</ul>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_IMAGE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
