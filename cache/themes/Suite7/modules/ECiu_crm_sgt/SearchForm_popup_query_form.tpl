...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='sgt_id_advanced'>{sugar_translate label='LBL_SGT_ID' module='ECiu_crm_sgt'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.sgt_id_advanced.value) <= 0}
{assign var="value" value=$fields.sgt_id_advanced.default_value }
{else}
{assign var="value" value=$fields.sgt_id_advanced.value }
{/if}  
<input type='text' name='{$fields.sgt_id_advanced.name}' 
    id='{$fields.sgt_id_advanced.name}' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='ECiu_crm_sgt'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
