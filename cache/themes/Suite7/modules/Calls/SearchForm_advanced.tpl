...
{/literal}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='current_user_only_advanced'>{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='direction_advanced'>{sugar_translate label='LBL_DIRECTION' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='direction_advanced' name='direction_advanced[]' options=$fields.direction_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.direction_advanced.value}
   	   	</td>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_start_advanced'>{sugar_translate label='LBL_DATE' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_date_start_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_start_advanced) && !empty($smarty.request.date_start_advanced)}{$smarty.request.date_start_advanced}{else}{$smarty.request.range_date_start_advanced}{/if}' title=''   size="11" style="width:100px !important;">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
{assign var=date_value value=$fields.date_start_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_start_advanced }' title=''  tabindex='' size="11" style="width:100px !important;">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_start_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_start_advanced }' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_end_advanced'>{sugar_translate label='LBL_DATE_END' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{assign var="id" value=$fields.date_end_advanced.name }

{if isset($smarty.request.date_end_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.date_end_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<div class="dateTimeRangeChoice" style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" style="width:125px !important;" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.date_end_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_date_end_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_end_advanced) && !empty($smarty.request.date_end_advanced)}{$smarty.request.date_end_advanced}{else}{$smarty.request.range_date_end_advanced}{/if}' title=''   size="11" style="width:100px !important;">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
{assign var=date_value value=$fields.date_end_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_end_advanced }' title=''  tabindex='' size="11" style="width:100px !important;">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_end_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_end_advanced }' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
