...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='ECiu_crm_badges'}</label>
    	</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='description_advanced'>{sugar_translate label='LBL_DESCRIPTION' module='ECiu_crm_badges'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
