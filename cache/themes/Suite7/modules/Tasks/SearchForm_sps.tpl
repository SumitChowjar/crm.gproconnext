...
{html_options id='collection_basic' name='collection_basic[]' options=$fields.collection_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.collection_basic.value}
   	   	</td>
