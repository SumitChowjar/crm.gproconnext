...
<li><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='LBL_TASK_INFORMATION' module='Tasks'}</em></a></li>

<li><a id="tab1" href="javascript:void(0)"><em>{sugar_translate label='LBL_PANEL_ASSIGNMENT' module='Tasks'}</em></a></li>
</ul>
