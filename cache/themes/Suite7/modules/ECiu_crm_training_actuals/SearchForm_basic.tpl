...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='recourd_type_basic' >{sugar_translate label='LBL_RECOURD_TYPE' module='ECiu_crm_training_actuals'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='recourd_type_basic' name='recourd_type_basic[]' options=$fields.recourd_type_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.recourd_type_basic.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='ECiu_crm_training_actuals'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='number_of_pastors_basic' >{sugar_translate label='LBL_NUMBER_OF_PASTORS' module='ECiu_crm_training_actuals'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.number_of_pastors_basic.value) <= 0}
{assign var="value" value=$fields.number_of_pastors_basic.default_value }
{else}
{assign var="value" value=$fields.number_of_pastors_basic.value }
{/if}  
<input type='text' name='{$fields.number_of_pastors_basic.name}' 
    id='{$fields.number_of_pastors_basic.name}' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='date_from_basic' >{sugar_translate label='LBL_DATE_FROM' module='ECiu_crm_training_actuals'}</label>
    	</td>
...
<span class="dateTime">
{assign var=date_value value=$fields.date_from_basic.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_from_basic.name}" id="{$fields.date_from_basic.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.date_from_basic.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.date_from_basic.name}",
form : "",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.date_from_basic.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='date_to_basic' >{sugar_translate label='LBL_DATE_TO' module='ECiu_crm_training_actuals'}</label>
    	</td>
...
<span class="dateTime">
{assign var=date_value value=$fields.date_to_basic.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_to_basic.name}" id="{$fields.date_to_basic.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.date_to_basic.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.date_to_basic.name}",
form : "",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.date_to_basic.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='hours_basic' >{sugar_translate label='LBL_HOURS' module='ECiu_crm_training_actuals'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.hours_basic.value) <= 0}
{assign var="value" value=$fields.hours_basic.default_value }
{else}
{assign var="value" value=$fields.hours_basic.value }
{/if}  
<input type='text' name='{$fields.hours_basic.name}' 
    id='{$fields.hours_basic.name}' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='ECiu_crm_training_actuals'}</label>
    	</td>
