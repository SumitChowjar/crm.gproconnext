...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name1_advanced'>{sugar_translate label='LBL_NAME1' module='ECiu_crm_ddc'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.name1_advanced.value) <= 0}
{assign var="value" value=$fields.name1_advanced.default_value }
{else}
{assign var="value" value=$fields.name1_advanced.value }
{/if}  
<input type='text' name='{$fields.name1_advanced.name}' 
    id='{$fields.name1_advanced.name}' size='30' 
    maxlength='255' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name2_advanced'>{sugar_translate label='LBL_NAME2' module='ECiu_crm_ddc'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.name2_advanced.value) <= 0}
{assign var="value" value=$fields.name2_advanced.default_value }
{else}
{assign var="value" value=$fields.name2_advanced.value }
{/if}  
<input type='text' name='{$fields.name2_advanced.name}' 
    id='{$fields.name2_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name3_advanced'>{sugar_translate label='LBL_NAME3' module='ECiu_crm_ddc'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.name3_advanced.value) <= 0}
{assign var="value" value=$fields.name3_advanced.default_value }
{else}
{assign var="value" value=$fields.name3_advanced.value }
{/if}  
<input type='text' name='{$fields.name3_advanced.name}' 
    id='{$fields.name3_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name4_advanced'>{sugar_translate label='LBL_NAME4' module='ECiu_crm_ddc'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.name4_advanced.value) <= 0}
{assign var="value" value=$fields.name4_advanced.default_value }
{else}
{assign var="value" value=$fields.name4_advanced.value }
{/if}  
<input type='text' name='{$fields.name4_advanced.name}' 
    id='{$fields.name4_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='ECiu_crm_ddc'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
