...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='key_id_label' width='12.5%' data-total-columns="2" scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_KEY_ID' module='ECiu_crm_ddc'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.key_id.value) <= 0}
{assign var="value" value=$fields.key_id.default_value }
{else}
{assign var="value" value=$fields.key_id.value }
{/if}  
<input type='text' name='{$fields.key_id.name}' 
id='{$fields.key_id.name}' size='30' 
maxlength='20' 
value='{$value}' title=''      >
<td valign="top" id='name_label' width='12.5%' data-total-columns="2" scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='ECiu_crm_ddc'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
addForm('EditView');addToValidate('EditView', 'name', 'name', false,'{/literal}{sugar_translate label='LBL_NAME' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'code1', 'varchar', false,'{/literal}{sugar_translate label='LBL_CODE1' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'name1', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME1' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'code2', 'varchar', false,'{/literal}{sugar_translate label='LBL_CODE2' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'name2', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME2' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'code3', 'varchar', false,'{/literal}{sugar_translate label='LBL_CODE3' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'name3', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME3' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'code4', 'varchar', false,'{/literal}{sugar_translate label='LBL_CODE4' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'name4', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME4' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidate('EditView', 'key_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_KEY_ID' module='ECiu_crm_ddc' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='ECiu_crm_ddc' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='ECiu_crm_ddc' for_js=true}{literal}', 'assigned_user_id' );
</script>{/literal}
