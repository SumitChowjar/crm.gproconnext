...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='category_basic' >{sugar_translate label='LBL_CATEGORY' module='ECiu_crm_resource_types'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.category_basic.value) <= 0}
{assign var="value" value=$fields.category_basic.default_value }
{else}
{assign var="value" value=$fields.category_basic.value }
{/if}  
<input type='text' name='{$fields.category_basic.name}' 
    id='{$fields.category_basic.name}' size='30' 
    maxlength='255' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='sub_category_basic' >{sugar_translate label='LBL_SUB_CATEGORY' module='ECiu_crm_resource_types'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.sub_category_basic.value) <= 0}
{assign var="value" value=$fields.sub_category_basic.default_value }
{else}
{assign var="value" value=$fields.sub_category_basic.value }
{/if}  
<input type='text' name='{$fields.sub_category_basic.name}' 
    id='{$fields.sub_category_basic.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='ECiu_crm_resource_types'}
		</td>
