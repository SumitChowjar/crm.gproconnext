...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='category_advanced'>{sugar_translate label='LBL_CATEGORY' module='ECiu_crm_resource_types'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.category_advanced.value) <= 0}
{assign var="value" value=$fields.category_advanced.default_value }
{else}
{assign var="value" value=$fields.category_advanced.value }
{/if}  
<input type='text' name='{$fields.category_advanced.name}' 
    id='{$fields.category_advanced.name}' size='30' 
    maxlength='255' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='sub_category_advanced'>{sugar_translate label='LBL_SUB_CATEGORY' module='ECiu_crm_resource_types'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.sub_category_advanced.value) <= 0}
{assign var="value" value=$fields.sub_category_advanced.default_value }
{else}
{assign var="value" value=$fields.sub_category_advanced.value }
{/if}  
<input type='text' name='{$fields.sub_category_advanced.name}' 
    id='{$fields.sub_category_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='ECiu_crm_resource_types'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
