...
<input type='text' name='{$fields.address_city_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='pastoral_journey_c_advanced'>{sugar_translate label='LBL_PASTORAL_JOURNEY' module='Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='pastoral_journey_c_advanced' name='pastoral_journey_c_advanced[]' options=$fields.pastoral_journey_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.pastoral_journey_c_advanced.value}
   	   	</td>
