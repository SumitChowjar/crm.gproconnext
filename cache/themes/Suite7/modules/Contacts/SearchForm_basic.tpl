...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='salutation_basic' >{sugar_translate label='LBL_SALUTATION' module='Contacts'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='salutation_basic' name='salutation_basic[]' options=$fields.salutation_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.salutation_basic.value}
   	   	</td>
