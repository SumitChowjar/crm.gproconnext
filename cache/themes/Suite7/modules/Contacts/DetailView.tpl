...
<li><a id="tab2" href="javascript:void(0)"><em>{sugar_translate label='LBL_DETAILVIEW_PANEL6' module='Contacts'}</em></a></li>
</ul>
...
{if !empty($fields.whatsapp_c.value)}
{assign var="phone_value" value=$fields.whatsapp_c.value }
{sugar_phone value=$phone_value usa_format="0"}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.google_hangouts_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.google_hangouts_c.name}">{$fields.google_hangouts_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wedding_anniversary_c.hidden}
...
{if strlen($fields.wedding_anniversary_c.value) <= 0}
{assign var="value" value=$fields.wedding_anniversary_c.default_value }
{else}
{assign var="value" value=$fields.wedding_anniversary_c.value }
{/if}
<span class="sugar_field" id="{$fields.wedding_anniversary_c.name}">{$value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.preferred_method_of_contact_c.hidden}
...
{if !empty($fields.preferred_method_of_contact_c.value) && ($fields.preferred_method_of_contact_c.value != '^^')}
<input type="hidden" class="sugar_field" id="{$fields.preferred_method_of_contact_c.name}" value="{$fields.preferred_method_of_contact_c.value}">
{multienum_to_array string=$fields.preferred_method_of_contact_c.value assign="vals"}
{foreach from=$vals item=item}
<li style="margin-left:10px;">{ $fields.preferred_method_of_contact_c.options.$item }</li>
{/foreach}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.preferred_method_of_descrip_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.preferred_method_of_descrip_c.name}">{$fields.preferred_method_of_descrip_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.preferred_frequen_of_contact_c.hidden}
...
{if is_string($fields.preferred_frequen_of_contact_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.preferred_frequen_of_contact_c.name}" value="{ $fields.preferred_frequen_of_contact_c.options }">
{ $fields.preferred_frequen_of_contact_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.preferred_frequen_of_contact_c.name}" value="{ $fields.preferred_frequen_of_contact_c.value }">
{ $fields.preferred_frequen_of_contact_c.options[$fields.preferred_frequen_of_contact_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.preferred_day_time_of_contac_c.hidden}
...
{if is_string($fields.preferred_day_time_of_contac_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.preferred_day_time_of_contac_c.name}" value="{ $fields.preferred_day_time_of_contac_c.options }">
{ $fields.preferred_day_time_of_contac_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.preferred_day_time_of_contac_c.name}" value="{ $fields.preferred_day_time_of_contac_c.value }">
{ $fields.preferred_day_time_of_contac_c.options[$fields.preferred_day_time_of_contac_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.stake_holder_type_c.hidden}
...
{if !empty($fields.stake_holder_type_c.value) && ($fields.stake_holder_type_c.value != '^^')}
<input type="hidden" class="sugar_field" id="{$fields.stake_holder_type_c.name}" value="{$fields.stake_holder_type_c.value}">
{multienum_to_array string=$fields.stake_holder_type_c.value assign="vals"}
{foreach from=$vals item=item}
<li style="margin-left:10px;">{ $fields.stake_holder_type_c.options.$item }</li>
{/foreach}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.pastoral_journey_c.hidden}
...
{if is_string($fields.pastoral_journey_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.pastoral_journey_c.name}" value="{ $fields.pastoral_journey_c.options }">
{ $fields.pastoral_journey_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.pastoral_journey_c.name}" value="{ $fields.pastoral_journey_c.value }">
{ $fields.pastoral_journey_c.options[$fields.pastoral_journey_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
...
{if is_string($fields.opsunit_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.opsunit_c.name}" value="{ $fields.opsunit_c.options }">
{ $fields.opsunit_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.opsunit_c.name}" value="{ $fields.opsunit_c.value }">
{ $fields.opsunit_c.options[$fields.opsunit_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
...
{counter name="panelFieldCount" start=0 print=false assign="panelFieldCount"}
<!-- PANEL CONTAINER HERE.. -->
<table id='LBL_DETAILVIEW_PANEL6' class="panelContainer" cellspacing='{$gridline}'>
{counter name="fieldsUsed" start=0 print=false assign="fieldsUsed"}
{counter name="fieldsHidden" start=0 print=false assign="fieldsHidden"}
{capture name="tr" assign="tableRow"}
<tr>
